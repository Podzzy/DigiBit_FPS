...
public class NetworkedPlayer : PlayerBehavior
{
    ...
    void Awake()
    {
        //Disable collision detection so that when Forge interpolates to start position, no collisions blocks the way
    ...
    protected override void NetworkStart()
    {
        ...
        //enable collisions here, as the transform lerp 0,0,0 thingy
